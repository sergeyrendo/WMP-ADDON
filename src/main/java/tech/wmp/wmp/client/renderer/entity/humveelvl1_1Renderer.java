package tech.wmp.wmp.client.renderer.entity;

import tech.wmp.wmp.client.model.humveelvl1_1Model;
...
public class humveelvl1_1Renderer extends GeoEntityRenderer<humveelvl1__1Entity> {

    public humveelvl1_1Renderer(EntityRendererProvider.Context renderManager) {
        super(renderManager, new humveelvl1_1Model());
        // Убираем дополнительный светящийся слой
        // this.addRenderLayer(new Lav150Layer(this));
    }

    @Override
    public RenderType getRenderType(humveelvl1__1Entity animatable, ResourceLocation texture, MultiBufferSource bufferSource, float partialTick) {
        return RenderType.entityTranslucent(getTextureLocation(animatable));
    }

    @Override
    public void preRender(PoseStack poseStack, humveelvl1__1Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
    ...
    @Override
    public void render(humveelvl1__1Entity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
        poseStack.pushPose();
    ...
    @Override
    public void renderRecursively(PoseStack poseStack, humveelvl1__1Entity animatable, GeoBone bone, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    protected float getDeathMaxRotation(humveelvl1__1Entity entityLivingBaseIn) {
        return 0.0F;
    }
}
