...
public class humveelvl1__1Entity extends ContainerMobileVehicleEntity implements GeoEntity, LandArmorEntity, ArmedVehicleEntity {
    ...
    public static humveelvl1__1Entity clientSpawn(PlayMessages.SpawnEntity packet, Level world) {
        ...
        EntityType<humveelvl1__1Entity> castedEntityType = (EntityType<humveelvl1__1Entity>) entityTypeFromPacket;
        humveelvl1__1Entity entity = new humveelvl1__1Entity(castedEntityType, world);
        return entity;
    }

    @Override
    public void registerControllers(AnimatableManager.ControllerRegistrar data) {
        data.add(new AnimationController<humveelvl1__1Entity>(this, "movement", 0, this::idlePredicate));
    }
    ...
    private PlayState idlePredicate(AnimationState<humveelvl1__1Entity> event) {
